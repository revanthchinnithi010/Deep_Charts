...
const s = StyleSheet.create({
  ...
  h1:       { fontSize: 22, fontWeight: "900", color: TEXT_PRI, fontFamily: "SFProDisplay-Bold", letterSpacing: -0.5 },
  subtitle: { fontSize: 13, color: MUTED, fontFamily: "SFProDisplay-Regular", marginTop: 2 },
  ...
  inputGroup: { gap: 5 },
  inputLabel: { fontSize: 10, fontWeight: "700", color: MUTED, fontFamily: "SFProDisplay-Bold", textTransform: "uppercase", letterSpacing: 0.8 },
  inputWrap:  { position: "relative" },
  textInput:  { height: 42, borderRadius: 10, paddingHorizontal: 10, fontSize: 14, fontWeight: "500", color: TEXT_PRI, fontFamily: "SFProDisplay-Medium", backgroundColor: BG_INPUT, borderWidth: 1, borderColor: BORDER40 },
  textInputSuffix: { paddingRight: 40 },
  suffix: { position: "absolute", right: 10, top: 0, bottom: 0, textAlignVertical: "center", fontSize: 11, color: MUTED, fontWeight: "700", fontFamily: "SFProDisplay-Bold" },
  ...
  chipText:         { fontSize: 11, fontWeight: "700", fontFamily: "SFProDisplay-Bold" },
  ...
  sideBtnText:      { fontSize: 12, fontWeight: "700", fontFamily: "SFProDisplay-Bold", textTransform: "capitalize" },
  ...
  livePrice:      { fontSize: 13, fontWeight: "900", color: TEXT_PRI, fontFamily: "SFProDisplay-Bold" },
  ...
  fillBtnText:    { fontSize: 10, fontWeight: "900", color: ACCENT, fontFamily: "SFProDisplay-Bold" },
  ...
  warnText:   { flex: 1, fontSize: 12, color: "#fca5a5", fontFamily: "SFProDisplay-Regular" },
  ...
  amberText:  { flex: 1, fontSize: 12, color: "#fcd34d", fontFamily: "SFProDisplay-Regular" },
  ...
  recLotsValue: { fontSize: 16, fontWeight: "900", color: ACCENT, fontFamily: "SFProDisplay-Bold", marginTop: 2 },
  ...
  resultsTitle:  { flex: 1, fontSize: 13, fontWeight: "700", color: TEXT_PRI, fontFamily: "SFProDisplay-Bold" },
  ...
  rrSub:        { fontSize: 11, color: MUTED, fontFamily: "SFProDisplay-Regular", marginTop: 1 },
});
