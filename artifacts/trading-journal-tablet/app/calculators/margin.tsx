...
const s = StyleSheet.create({
  ...
  chipText: { fontSize: 12, fontWeight: "700", fontFamily: "SFProDisplay-Bold" },
  ...
  safeText: { flex: 1, fontSize: 12, color: "rgba(237,240,246,0.60)", fontFamily: "SFProDisplay-Regular" },
