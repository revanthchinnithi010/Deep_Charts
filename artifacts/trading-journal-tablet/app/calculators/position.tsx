...
const s = StyleSheet.create({
  ...
  resultsTitle: { fontSize: 13, fontWeight: "700", color: TEXT_PRI, fontFamily: "SFProDisplay-Bold" },
  ...
  heroValue: { fontSize: 28, fontWeight: "900", color: ACCENT, fontFamily: "SFProDisplay-Bold", lineHeight: 30 },
  ...
  resultRowLabel: { fontSize: 13, color: MUTED, fontFamily: "SFProDisplay-Regular" },
  ...
  breakEvenValue: { fontSize: 15, fontWeight: "900", color: ACCENT, fontFamily: "SFProDisplay-Bold" },
});
