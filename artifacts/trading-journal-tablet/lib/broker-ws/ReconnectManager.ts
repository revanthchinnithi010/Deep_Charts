/**
 * ReconnectManager.ts — exponential-backoff reconnect scheduler.
 *
 * React Native port of src/lib/broker-ws/ReconnectManager.ts
 * ───────────────────────────────────────────────────────────
 * No modifications required.  Uses only setTimeout / clearTimeout,
 * which are available identically in both the browser and React Native /
 * Hermes.  Logic is preserved exactly.
 */
